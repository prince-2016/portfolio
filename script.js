...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (typewriterElement) {
        const roles = ["Full Stack Developer", "BCA Graduate", "Creative Programmer", "Database Architect"];
        let roleIdx = 0;
        let charIdx = 0;
    ...
    /* ==========================================================================
       7. CONTACT VALIDATION & SUBMIT SPINNER (ONLY ON contact.html)
       ========================================================================== */
    ...
    if (contactForm && submitBtn && successOverlay) {
        contactForm.addEventListener('submit', (e) => {
            ...
            // Emulate secure transmit delays (1.6s)
            setTimeout(() => {
                submitBtn.classList.remove('loading');
                submitBtn.disabled = false;
                
                // Slide success alert in
